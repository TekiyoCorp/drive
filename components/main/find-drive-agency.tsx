...
const FindDriveAgency = () => {
  ...
  return (
    <div className="relative z-0 w-full p-2.5 md:p-4 min-h-screen h-full">
      ...
      <Image
        ...
        width={1024}
        height={1024}
        className="object-cover object-center -z-10 w-[96%] sm:w-[98%] min-h-screen h-full absolute top-0 left-1/2 -translate-x-1/2 rounded-3xl"
      />
      {/* </Container> */}
